...
void saveSnippet(NSString *prefix, NSString *protocolName,  NSString *content) {
    ...
    content = [@"// This file is generated by dnsip, a tiny utility that extracts \n  \
    ...
    [snippet setObject:@[@"ClassImplementation"] forKey:@"IDECodeSnippetCompletionScopes"];
    ...
    [snippet setObject:[NSString stringWithFormat:@"Delegate with all methods of %@", protocolName ] forKey:@"IDECodeSnippetSummary"];
    
    [snippet setObject:[NSString stringWithFormat:@"Delegate for %@", protocolName] forKey:@"IDECodeSnippetTitle"];
